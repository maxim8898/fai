...
$out .="<tr bgcolor=$middle_color><td class=lf_tr></td><td class=lf_tr></td><td class=lf_tr>�</td><td class=lf_tr>����</td><td class=lf_tr align=center><b>����������</b></td><td class=lf_tr>PID</td><td class=lf_tr>img</td><td class=lf_tr></td></tr>";
while($Row=mysql_fetch_assoc($r)) {
  ...
  $out .="<tr>
  <td class=lf_tr width=12><INPUT type='checkbox' name='chvisible' "; if ($Row[visible]) $out.=" checked title='�������'"; $out .=" title='�� �������' onclick=\"JumpURL('anews.php?NID=$Row[NID]&visible=$newvisible');\"></td>
  <td class=lf_tr width=16><a href=anews.php?NID=$Row[NID]&Nedit=1><img src='../img/b_edit.png' alt='��������' border=0></a></td>
...
<td class=lf_tr align=center>$icon</td>
  <td class=lf_tr width=16><a href=\"javascript:confirmDelete('������� �������?','anews.php?NID=$Row[NID]&Nedit=1&del=1');\"><img src='../img/b_drop.png' alt='�������' border=0></a></td>
  </tr>";
}
$out .="</table>";
$out .= "<br><center><a href = anews.php?New=1&Nedit=1>�������� �������</a></center>";
...
<TABLE border="1" width="100%" cellpadding="2" cellspacing="3" bgcolor= <?php echo "$light_color"; ?>>
    <TR>
      <TD align="center" background="../img/but_f.gif">��������� �������� (�������)</TD>
    </TR>
    <TR>
      <TD valign="top">
	<?php echo "$out"; ?>
