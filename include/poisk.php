...
if (isset($searchstring) && $searchstring <>''){
	...
	$s.="ORDER BY name";
	$q = mysql_query($s);
	$i=0; $outstr ="<TABLE border=0 width=100% cellpadding=2><tr><td class=lf_tr width=100% bgcolor = $dark_color><font color=#ffffff><b>Ќайдено в категори€х</b></font></td></tr>";
	...
	$i=0;
	$i=0; $outstr ="<TABLE border=0 width=100% cellpadding=2><tr><td class=lf_tr width=100% bgcolor = $dark_color><font color=#ffffff><b>Ќайдено в материалах сайта</b></font></td></tr>";
	while ($row = mysql_fetch_assoc($q)){
	...
	$q = mysql_query($s);
	$i=0; $outstr ="<TABLE border=0 width=100% cellpadding=2><tr><td class=lf_tr width=100% bgcolor = $dark_color><font color=#ffffff><b>Ќайдено на форумах</b></font></td></tr>";
	while ($row = mysql_fetch_assoc($q)){
